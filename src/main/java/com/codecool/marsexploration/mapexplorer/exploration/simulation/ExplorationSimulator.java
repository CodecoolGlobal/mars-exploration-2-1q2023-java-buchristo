...
public class ExplorationSimulator {
    ...
    public void run() {
        ...
        while (simulationState.isRunning()) {
            ...
            logger.log("STEP " + simulationState.getNumberOfStepsTaken() + "; EVENT: Moved to position " + rover.getCurrentPos());
        }
        if (simulationState.isSuccess()) {
            logger.log("STEP " + simulationState.getNumberOfStepsTaken() + "; OUTCOME: COLONIZABLE");
            mapLogger.drawExploredMap(map, simulationState.getVisitedCoordinates());
        } else {
            logger.log("STEP " + simulationState.getNumberOfStepsTaken() + "; OUTCOME: TIMEOUT");
            mapLogger.drawExploredMap(map, simulationState.getVisitedCoordinates());
        }
